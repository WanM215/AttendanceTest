            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Student in (<?php echo $rrw['programme_name'].' - '.$rrw['course_name'];?>) Programme</h6>
                ...
                <?php echo $statusMsg; ?>
                  ...
                  <?php
                      $query = "SELECT tblstudents.id,tblstudents.admissionNumber,tblprogramme.programme_name,tblprogramme.id As programme_id,tblcourse.course_name,tblcourse.id AS course_id,tblstudents.fullname,
                      ...
                      where tblstudents.programme_id = '$_SESSION[programme_id]' and tblstudents.course_id = '$_SESSION[course_id]'";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
