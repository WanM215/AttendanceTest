                ...
                <div class="login-form">
                  ...
                  <form class="user" method="Post" action="">
                    <div class="form-group">
                      <input type="text" class="form-control" required name="username" id="exampleInputEmail" placeholder="Enter Your Username">
                    </div>
                    <div class="form-group">
...
<?php
  ...
  if(isset($_POST['login'])){
    ...
    $query = "SELECT * FROM tblteacher WHERE username = '$username' AND password = '$password'";
    $rs = $conn->query($query);
    $num = $rs->num_rows;
    $rows = $rs->fetch_assoc();
    ...
    if($num > 0){
      ...
      $_SESSION['programme_id'] = $rows['programme_id'];
...
?>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="font-weight-bold small" href="TeacherLogin.php">Lecturer Login!</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
