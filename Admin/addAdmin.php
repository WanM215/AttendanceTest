...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from tbladmin where staffNumber ='$staffNumber'");
    $ret=mysqli_fetch_array($query);

    if($ret > 0){ 

        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This Staff Number Already Exists!</div>";
    }
    else{

        $query=mysqli_query($conn,"insert into tbladmin(username,fullname,staffNumber,password,email) value('$username','$fullname','$staffNumber','$password','$email')");
 ...
 if (isset($_GET['id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update tbladmin set username='$username', fullname='$fullname', staffNumber='$staffNumber', password='$password', email='$email' where id='$id'");
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="post">
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Staff Number<span class="text-danger ml-2">*</span></label>
                            <input type="text" class="form-control" name="staffNumber" value="<?php echo $row['staffNumber'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
