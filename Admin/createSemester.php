...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from tblsemester where semester_name ='$semester_name' and term_id = '$term_id'");
    $ret=mysqli_fetch_array($query);

    if($ret > 0){ 

        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This Semester and Term Already Exists!</div>";
    }
    else{

        $query=mysqli_query($conn,"insert into tblsemester(semester_name,term_id,isActive,dateCreated) value('$semester_name','$term_id','0','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    $dateCreated = date("Y-m-d");
            ...
            $query=mysqli_query($conn,"update tblsemester set semester_name='$semester_name',term_id='$term_id',isActive='0' where id='$id'");
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Semester & Term</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Create Semester & Term</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Create Semester & Term</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="semester_name" value="<?php echo $row['semester_name'];?>" id="exampleInputFirstName" placeholder="Semester">
                        </div>
                        <div class="col-xl-6">
                            <label class="form-control-label">Term<span class="text-danger ml-2">*</span></label>
                              <?php
                        $qry= "SELECT * FROM tblterm ORDER BY term_name ASC";
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Semester & Term</h6>
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblsemester.id,tblsemester.semester_name,tblsemester.isActive,tblsemester.dateCreated,
                      tblterm.term_name
                      FROM tblsemester
